...
Git global setup
git config --global user.name "Jonier Cabrera"
git config --global user.email "jonier.cabrera@cosmitet.net"

Create a new repository
git clone http://gitlab.example.com/asistencial/dusoftmovil.git
cd dusoftmovil
touch README.md
git add README.md
...
cd existing_folder
git init
git remote add origin http://gitlab.example.com/asistencial/dusoftmovil.git
git add .
